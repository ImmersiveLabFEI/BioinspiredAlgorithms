...
%
%
function bests = gpsFireflyThresholds(histograma,thresholds,NFireflies,iter,METHOD)
...
switch METHOD
    ...
    case {'TE'}
      for k=1:n  
         zn(k)= psrAvaliacaoTsallis(histograma, 0.35, fireflies(k,:));  
      end
    case {'ECE'}
      for k=1:n  
         zn(k)= psrAvaliacaoExponentialCrossEntropy(histograma, 0.35, fireflies(k,:));  
      end      
    otherwise
